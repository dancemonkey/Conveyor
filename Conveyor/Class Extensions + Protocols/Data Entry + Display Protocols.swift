...
extension ItemDisplayer where Self: ItemListVC {
  func initializeFRC() -> NSFetchedResultsController<Item> {
    ...
    fetchRequest.sortDescriptors = [NSSortDescriptor(key: "state", ascending: false), NSSortDescriptor(key: "priority", ascending: false), NSSortDescriptor(key: "holdDays", ascending: true), NSSortDescriptor(key: "title", ascending: true)]
